...
TodoList.prototype = {
    ...
    _fill_ui : function(){
        ...
        this.todosSec.addMenuItem(named_separator);

        for(var id in this.projects)
            this._add_section(this.projects[id], false);
    ...
    _enable : function() {
        // Connect file 'changed' signal to _refresh
